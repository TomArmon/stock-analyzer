...
export default function StatsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      <h1 className="text-2xl font-bold text-slate-800 mb-8">Stats</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
        <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-5">Top Tickers</h2>
        <div className="space-y-3">
          {data.top_tickers.map(({ ticker, count }) => (
            <div key={ticker} className="flex items-center gap-3">
              <span className="text-sm font-semibold text-slate-700 w-14 shrink-0">{ticker}</span>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-5">Recent Searches</h2>
